...
/**
 * El tarifario financiero se publica en pesos: una unidad cotizada en otra
 * moneda no se puede simular sin un tipo de cambio confirmado por el negocio.
 * Se publica en el catálogo con su precio real y queda fuera del motor, en
 * lugar de convertirse con una cotización inventada.
 */
export const FINANCEABLE_CURRENCY = "ARS";

export function isFinanceableCurrency(currency) {
  return currency === FINANCEABLE_CURRENCY;
}
