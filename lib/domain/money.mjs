// El catálogo publica unidades en pesos y unidades importadas cotizadas en
// dólares. Cada Money conserva su moneda y las operaciones entre monedas
// distintas fallan: no hay tipo de cambio confirmado por el negocio, así que
// convertir sería inventar un dato comercial.
const SUPPORTED_CURRENCIES = new Set(["ARS", "USD"]);
