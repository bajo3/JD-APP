export const MAX_STOCK_IMAGE_BYTES = 5 * 1024 * 1024;
...
const ERROR_MESSAGES = Object.freeze({
  ...
  [MEDIA_POLICY_ERROR_CODES.TOO_LARGE]: "La imagen supera el máximo de 5 MiB.",
...
export async function inspectStockImage({ bytes, declaredContentType } = {}) {
  ...
  if (input.byteLength > MAX_STOCK_IMAGE_BYTES) {
    fail(MEDIA_POLICY_ERROR_CODES.TOO_LARGE, {
      byteSize: input.byteLength,
      maximumByteSize: MAX_STOCK_IMAGE_BYTES,
    });
  }
...
function normalizeContentType(value) {
  ...
  if (!STOCK_IMAGE_CONTENT_TYPES.includes(normalized)) {
    fail(MEDIA_POLICY_ERROR_CODES.UNSUPPORTED_CONTENT_TYPE, {
