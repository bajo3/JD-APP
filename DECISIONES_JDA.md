...
| 14 | Agente por canal | JDA | Falta confirmar horario y política fuera de horario. | Cada cuenta tiene un interruptor maestro apagado por defecto. Encendido: las conversaciones nuevas nacen con el agente; las existentes siguen humanas. Apagado: corta la IA y devuelve las abiertas a una persona. Sin `ANTHROPIC_API_KEY` no se puede activar. | Clave de Anthropic cargada y horario/política confirmados por JDA. | Todos los canales permanecen en atención humana. |
